...
$result = $block->query("SELECT id,title FROM rafia_forum where allow='yes' ORDER BY id DESC limit 10");
...
$index_middle .= "$limg&nbsp;&nbsp; <a href=forum.php?action=view&id=$id><b>$title</b></a>&nbsp;&nbsp;&nbsp;&nbsp;";
}
