...
<center><table border='0' width='100%' align='center' cellpadding='".$downColcount."'><tr>";
$result = mysql_query("SELECT * FROM rafia_cat WHERE catType='3' and subcat='0' ORDER BY ordercat ASC");
...
<span class=fontht dir=rtl>
<img border="0" src="images/b1.gif" align="middle" width="8" height="8">
<a href=download.php?action=list&cat_id=$id> $title</a> </span>


<span class=fontablt>
<img border="0" src="images/topics.gif" align="middle" alt="ÚÏÏ ÇáãæÇÖíÚ">
